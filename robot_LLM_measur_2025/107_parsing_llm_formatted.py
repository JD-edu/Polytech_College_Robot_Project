...
# --- 4. API 엔드포인트 정의 (JSON 응답 파싱 및 리스트 변환 추가) ---
    ...
    try:
        ...
        if chatgpt_response.choices and chatgpt_response.choices[0].message.content:
            ...
            try:
                ...
                # --- NEW: Parse LLM's JSON into a simplified list ---
                ...
                final_response = {
                    ...
                    "measurement_order_full_json": parsed_measurement_data, # Retain the full LLM JSON for debugging
                    "simplified_measurement_list": simplified_measurement_list # New simplified list for direct use
                }
